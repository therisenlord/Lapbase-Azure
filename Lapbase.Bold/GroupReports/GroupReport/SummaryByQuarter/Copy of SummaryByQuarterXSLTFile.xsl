...
<html>
	...
	<body class="printPreview">
		<div class="summaryByQuarterReport">
						...
						<td>
							<table style="width:800px">
								<tr>
									...
									<td style="width:63px; text-align:right">Start Weight</td>
									<td style="text-align:right; width:70px">Current Weight</td>
			...
			<xsl:variable name="Num2yO" select="count(/dsSchema/tblPWDList[(FollowupDays &gt; 270) and (FollowupDays &lt;= 365)])"/>
					...
					<tr>
						...
						<td class="border" style="height:98px; vertical-align:top;width:392px">
							...
							<table border="0" style="width100%">
								<tbody>
									<tr>
										<td colspan="7">Average Age: 42</td>
									</tr>
									<tr>
										...
										<td style="width:50px">
											%<xsl:value-of select="format-number(100* $cntFemale div ($cntFemale + $cntMale), '##.0')"/>
										</td>
										<td style="width:60px">
											<strong>Male</strong>
										</td>
...
<xsl:template name="MakeEWLFooterData">
	...
	<tr>
		<td>
			<xsl:value-of select="$cntPatient"/> patients
		</td>
		<td>&#160;</td>
		<td class="highlight" align="center">Age</td>
		<td class="highlight" align="center">Start Weight</td>
		<td class="highlight" align="center">Weight</td>
				...
				<tbody>
					<tr>
						<td align="center" width="25%">
							...
							<xsl:value-of select="format-number(($EWL_LT_25 div $cntVisit) * 100, '##.0')"/>
						</td>
						<td align="center" width="25%">
							<strong>EWL 25-50 : </strong>
							<xsl:value-of select="format-number(($EWL_LT_50 div $cntVisit) * 100, '##.0')"/>
						</td>
						<td align="center" width="25%">
							<strong>EWL50-75 : </strong>
							<xsl:value-of select="format-number(($EWL_LT_75 div $cntVisit) * 100, '##.0')"/>
						</td>
						<td align="center" width="25%">
							<strong>EWL &gt;75 : </strong>
							<xsl:value-of select="format-number(($EWL_LT_100 div $cntVisit) * 100, '##.0')"/>
						</td>
					</tr>
				</tbody>
			</table>
