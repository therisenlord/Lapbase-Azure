	...
	<body >
        ...
        <tr>
          ...
          <td style="font-weight:bold;">
            <xsl:value-of select="dsSchema/tblReport/DrAddress1"/>
          </td>
        </tr>
        <tr >
          ...
          <td style = "font-weight:bold;">
            <xsl:value-of select="dsSchema/tblReport/DrAddress2"/>
          </td>
        </tr>
        <tr>
          <td colspan = "2">
          ...
          <td style = "font-weight:bold;">
            <xsl:value-of select="dsSchema/tblReport/DrAddress3"/>
          </td>
        </tr>
        <tr>
          <td colspan = "2"/>
		...
		-->
				...
				<tr>
					...
					<td colspan = "3">
						...
						</label> <span style = "font-weight:bold;"><xsl:value-of select='translate(dsSchema/tblReport/Patname, "`", "&apos;")'/>
            </span> - <xsl:value-of select="dsSchema/tblReport/Address"/>  Age  <xsl:value-of select="dsSchema/tblReport/AGE"/> yrs
					</td>
				</tr>
