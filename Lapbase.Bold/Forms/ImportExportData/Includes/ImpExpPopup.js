...
//---------------------------------------------------------------------------------------------------------------
function btnExportDataJS_onclick( ){
    document.getElementById("btnExportData").style.display = "none";
    SetInnerText(document.getElementById("linkLocalMDB"), "");
    SetInnerText(document.getElementById("lblProgress"), "The export process is running in the background. It might take some time, depending on the data size. Please wait.");
