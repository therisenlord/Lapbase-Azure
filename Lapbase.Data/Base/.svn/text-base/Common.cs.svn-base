...
namespace Lapbase.Data
{
    public class Common
    {
        ...
        /// <summary>
        /// Gets the encrypted data for input parameter.
        /// </summary>
        /// <param name="strValue">input string value to be encrypted</param>
        /// <returns></returns>
        static public Byte[] GetSecureBinaryData(String strValue)
        {
