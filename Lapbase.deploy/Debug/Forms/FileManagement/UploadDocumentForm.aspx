<%@ page language="C#" autoeventwireup="true" inherits="Forms_FileManagement_UploadDocumentForm, Lapbase.deploy" enableEventValidation="false" viewStateEncryptionMode="Always" %>
...
<body style="width:100%;" id = "bodyUploadFile" >
    <form id="frmUploadDocument" runat="server" enctype ="multipart/form-data" >
        ...
        <div class="fakePopUpWindow">
            <div class="fakePopUpWindowTitle"><h4 id = "lblUploadfile">Upload file</h4></div>
            <asp:UpdatePanel ID="UPanel1" UpdateMode="always" runat="server">
                <ContentTemplate>
                    <div class="fakePopUpWindowContent">
                        <table width = "100%" cellpadding = "3" cellspacing = "0" border = "0">
                            <tr style="height :30px; vertical-align:top;">
                                ...
                                <td >
                                    <asp:FileUpload runat = "server" ID = "uploadDocFile" Width = "100%" />
                                </td>
                            ...
                            <tr style="height :30px; vertical-align:top;">
                                ...
                                <td >
                                    <wucTextBox:TextBox runat = "server" id = "txtDescription" width = "90%" textMode="MultiLine" rows ="2" />
                                </td>
                            </tr>
                            <tr style="height :30px; vertical-align:top;">
                                <td><asp:label runat = "server" ID = "lblDate" Text = "Date" /></td>
                                <td><wucTextBox:TextBox runat = "server" id = "txtDate" width = "25%" textMode="SingleLine" maxLength="10" /></td>
                            </tr>
                            <tr style="height :30px; vertical-align:top;">
                                <td><asp:label runat = "server" ID = "lblEvent" Text = "Event" /></td>
                                <td>
                    ...
                    <div class="fakePopUpWindowFooter">
                        <a href="#" class="lbAction" rel="deactivate" style="float:right"><button id = "btnClose" style="width:100px" >Close</button></a>
                        <input type="button" runat = "server" id = "btnUpload" value = "Upload"  onclick="javascript:btnUpload_onclick();" style="width:100px;float:right"/>
                        <asp:LinkButton runat = "server" ID = "linkBtn" Text = "Click me" OnClick = "btnUpload_OnClick" style="display:none"/>
                    </div>
