<%@ page language="C#" autoeventwireup="true" inherits="Forms_ImportExportData_UpdateSurgeryType, Lapbase.deploy" enableEventValidation="false" viewStateEncryptionMode="Always" %>
...
<body runat = "server">
    ...
    <div class="tabMenus">
	    <wucAppSchemaFunc:AppSchemaFunc runat = "server" ID = "AppSchemaFuncMenu" currentItem = "UpdateSurgeryType" />
	</div>
		    ...
		    <div class="greyContentWrap">
			    <div>
			        <table width="100%">
			            <tr>
			                <td>
                                <input type="button" id="btnCheck" value="Check" runat="server" onserverclick="checkSurgery"/>			                
			                </td>
			                <td>
                                <input type="button" id="btnUpdate" value="Update" runat="server" onserverclick="updateSurgery"/>
                            </td>
                        </tr>
			            <tr>
