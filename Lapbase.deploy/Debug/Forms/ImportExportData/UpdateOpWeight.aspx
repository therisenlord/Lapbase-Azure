<%@ page language="C#" autoeventwireup="true" inherits="Forms_ImportExportData_UpdateOpWeight, Lapbase.deploy" enableEventValidation="false" viewStateEncryptionMode="Always" %>
...
<body runat = "server">
    ...
    <div class="tabMenus">
	    <wucAppSchemaFunc:AppSchemaFunc runat = "server" ID = "AppSchemaFuncMenu" currentItem = "UpdateOpWeight" />
	</div>
		    ...
		    <div class="greyContentWrap">
			    <div>
			        <table width="100%">
			            <tr>
			                <td>
                                <input type="button" id="btnUpdateOpWeight" value="Update Single Operation Weight" runat="server" onserverclick="updateOpWeight"/>			                
			                </td>
			                <td>
			                    &nbsp;
			                </td>
