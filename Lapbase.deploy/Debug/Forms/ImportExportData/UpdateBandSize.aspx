<%@ page language="C#" autoeventwireup="true" inherits="Forms_ImportExportData_UpdateBandSize, Lapbase.deploy" enableEventValidation="false" viewStateEncryptionMode="Always" %>
...
<body runat = "server">
    ...
    <div class="tabMenus">
	    <wucAppSchemaFunc:AppSchemaFunc runat = "server" ID = "AppSchemaFuncMenu" currentItem = "UpdateBandSize" />
	</div>
