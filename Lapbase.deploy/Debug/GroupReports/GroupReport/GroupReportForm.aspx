<%@ page language="C#" autoeventwireup="true" inherits="Reports_GroupReport_GroupReportForm, Lapbase.deploy" enableEventValidation="false" viewStateEncryptionMode="Always" %>
    ...
    <div class="tabMenus">
        <div class="greyTabMenu">
            <ul>
                ...
                <li id="li_Div3" runat="server" style="display:none"><a id="a_BSRReport" href="#"
                    onclick="javascript:LoadDiv(3);">BSR Reports</a></li>
            </ul>
        </div>
    </div>
    <form id="frmGroupReport" runat="server">
        ...
        <div class="contentArea">
            ...
            <div class="greyContentWrap">
                                ...
                                <ContentTemplate>
                                    <table border="0" style="width: 100%">
                                        <tr>
                                            ...
                                            <td style="width: 10%">
                                                <wucTextBox:TextBox ID="txtSDate" runat="server" maxLength="10" width="100px"/>
                                            </td>
                                            <td style="width: 30%"> &nbsp &nbsp </td>
                                            <td style="width: 10%">
                                                <asp:Label ID="Label1" runat="Server" Text="End" /></td>
                                            <td style="width: 10%">
                                                <wucTextBox:TextBox ID="txtEDate" runat="server" maxLength="10" width="100px"/>
                                            </td>
                                            <td style="width: 30%"> &nbsp &nbsp </td>
                                        </tr>
                                    </table>
                                            ...
                                            <td colspan="11">
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <b>
                                                                <asp:Label ID="lblSerialNo" runat="Server" Text="Serial No" /></b></td>
                                                        <td>
                                                            <wucTextBox:TextBox ID="txtSerialNo" runat="server" width="100px" /> Only for Operation Details Report
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                    ...
                    <div class="excellReports">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <label id="lblPatientProgress" onmouseover="javascript:this.style.cursor='pointer';" onmouseout="javascript:this.style.cursor='';"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label id="lblPatientFollowUp" onmouseover="javascript:if (!this.disabled) this.style.cursor='pointer';"
                                                ...
                                                Display patients that have not been followed up for </label> <input type="text" id="monthsFollowup" size="2" maxlength="3"/> <label id="lblmonths"> months</label>
                                        </td>
                                    </tr>
                                </table>
                            </li>
                            ...
                            <li>
                                ...
                                <table border="0" style="width: 100%">
                                    <tr>
                                        <td style="width: 150px" id="lblSelectFormat">
                                        ...
                                        <td>
                                            <select id="cmbReportFormat" style="display: block; width: 100px">
                                                ...
                                                <option value="5" id="htmlReport" runat="server" visible="false">HTML</option>
                                            </select>
                                        </td>
                                    </tr>
                                </table>
                ...
                <div class="groupReportsSection" id="divBSRReport" style="display: none">
                    <div class="groupReports">
                        <h3 id="H3_1">
                            <img id="Img1" runat="server" alt="." src="~/img/btn_reports.gif" height="16" width="16" />
                            BSR Report</h3>
                            <br /><br />
                            <input type="button" id="Button1" value="Download" onclick="javascript:BuildReport(1);"
                                style="width: 80px" />
                    </div>
                    <div class="clr">
                    </div>
