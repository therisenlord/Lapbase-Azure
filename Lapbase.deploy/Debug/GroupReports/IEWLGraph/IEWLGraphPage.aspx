<%@ page language="C#" autoeventwireup="true" inherits="Reports_IEWLGraph_IEWLGraphPage, Lapbase.deploy" enableEventValidation="false" viewStateEncryptionMode="Always" %>
...
<body onload = "javascript:InitializePage('rptIEWLGraph');">
    <form id="rptIEWLGraph" runat="server">
        <div class="printPreview">
            <div class="printPreviewContent">
                ...
                <br /><br>
                <label style="font-weight:bold">First 24 months</label>
                <dotnet:Chart ID = "chartIEWL" runat = "server"  width="750px" height="421px" CssClass="graph"  />
                <br /><br /><br /><br />
                <label style="font-weight:bold" id="lblNextVisit" runat="server">After first 24 months</label>
                <dotnet:Chart ID = "chartIEWLNext" runat = "server"  width="750px" height="421px" CssClass="graph"  />
            </div>
        </div>
