<%@ page language="C#" autoeventwireup="true" inherits="Reports_EWLGraph_EWLGraphPage, Lapbase.deploy" enableEventValidation="false" viewStateEncryptionMode="Always" %>
...
<body onload = "javascript:InitializePage('rptEWLGraph');">
    <form id="rptEWLGraph" runat="server">
        <div class="printPreview">
            <div class="printPreviewContent">
                ...
                <dotnet:Chart ID = "chartEWL" runat = "server"  width="750px" height="421px" CssClass="graph"  />
            </div>
        </div>
