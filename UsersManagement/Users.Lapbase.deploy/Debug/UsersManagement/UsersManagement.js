...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function hDeactivate_onclick(OrganizationCode, PermissionFlag){
    if (window.confirm((PermissionFlag == 1) ? "Activate user?" : "Deactivate user?")){
        document.forms[0].txtHOrganizationCode.value = OrganizationCode +  ";" + ((PermissionFlag == 1) ? 0 : 1);
        __doPostBack('btnDeactivate','');
    }
    else document.forms[0].onsubmit = function(){return false;}
}
...
function UserRow_onclick(UCode, OrgCode){
    ...
    document.forms[0].chkShowLog.checked = (document.all) ? trRow.cells[10].innerText == "true" : trRow.cells[10].textContent == "true";
    document.forms[0].chkShowRegistry.checked = (document.all) ? trRow.cells[11].innerText == "true" : trRow.cells[11].textContent == "true";
...
function OrganizationRow_onclick(objRow, intCode, strLanguage){
    ...
    document.forms[0].txtAdminEmail_txtGlobal.value = document.all ? objRow.cells[11].innerText : objRow.cells[11].textContent;
    
    
    var exportData = document.all ? objRow.cells[12].innerText : objRow.cells[12].textContent;
    if (exportData.toLowerCase() == "true")
        document.forms[0].radioExport_yes.checked = true;
    else 
        document.forms[0].radioExport_no.checked = true;
        
    var bsrExportData = document.all ? objRow.cells[13].innerText : objRow.cells[13].textContent;
    if (bsrExportData.toLowerCase() == "true")
        document.forms[0].radioBSRExport_yes.checked = true;
    else 
        document.forms[0].radioBSRExport_no.checked = true;
